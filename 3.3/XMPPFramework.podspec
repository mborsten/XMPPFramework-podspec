Pod::Spec.new do |s|
  ...
  s.frameworks  = 'CFNetwork', 'SystemConfiguration', 'CoreData', 'CoreLocation', 'libresolv'
  s.library      = 'xml2', 'libdn'
  s.requires_arc = true
  s.xcconfig     = { 'HEADER_SEARCH_PATHS' => '$(SDKROOT)/usr/include/libxml2', 'LIBRARY_SEARCH_PATHS' => '"$(PODS_ROOT)/XMPPFramework/Vendor/libdn"' }
